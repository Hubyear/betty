        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-warning btn-sm btn-soft"><i class="fa fa-plus"></i> Add New</a>
            </div>
            <div class="box-body">
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>
                            <button class='btn btn-success btn-sm btn-soft edit' data-id='".$row['attid']."'><i class='fa fa-edit'></i> Edit</button>
                            <button class='btn btn-danger btn-sm btn-soft delete' data-id='".$row['attid']."'><i class='fa fa-trash'></i> Delete</button>
                          </td>
                        </tr>
                      ";
                    }
